...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"user as user; else showLogin\">\n  <h1>Hello {{ user.displayName }}!</h1>\n  <button (click)=\"logout()\">Logout</button>\n</div>\n<ng-template #showLogin>\n  <p>Please login.</p>\n  <button (click)=\"login()\">Login with Google</button>\n</ng-template>\n");
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        let provider = new firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider();
...
const bootstrap = () => {
    Object(_angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_2__["platformBrowserDynamic"])().bootstrapModule(_app_app_module__WEBPACK_IMPORTED_MODULE_3__["AppModule"], { ngZone: 'noop' }).catch(err => console.error(err));
};
...
module.exports = __webpack_require__(/*! C:\development\learning\angular-fire-learning\cordova\angularfire-login-device\src\main.ts */"./src/main.ts");
